...
//       <div className="container mx-auto my-5 bg-violet-400 p-5 min-h-[80vh]">
//         <div className="addTodo">
//         <h2 classsName='text-lg font-bold'>Add a Todo</h2> 
//         <input type="text"/>
...
//         <div className="text">Lorem ipsum dolor  minima.</div>
//         <div className="buttons">
//           <button  className='bg-violet-800 hover:bg-violet-950 p-2 py-1 text-sm font-bold text-white rounded-md mx-6'>Edit</button>
//           <button  className='bg-violet-800 hover:bg-violet-950 p-2 py-1 text-sm font-bold text-white rounded-md mx-6'>Delete</button>
//         </div>
//        </div>
